...
let listData = [
  {icon: require('../../res/images/list_8.png'), title: '项目小模块', class: '', info: ''},
  {icon: require('../../res/images/list_9.png'), title: '动画', class: '', info: ''},
  {icon: require('../../res/images/list_10.png'), title: '三方库的使用', class: '', info: ''},
  {icon: require('../../res/images/list_11.png'), title: '自定义组件', class: '', info: ''},
];

export default class LQJGoodsIndexPage extends Component {
  constructor(props) {
    super(props);
    this.state = {}
  }
  ...
  _itemClick(item, index) {
    if(index === 0){
      Actions.SmallerModuleIndexPage();
    }
  }
